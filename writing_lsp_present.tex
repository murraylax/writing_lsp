...
\newcommand{\ft}[1]{
  \frametitle{\begin{tabular}{p{4.2in}r} \textcolor{white}{#1} & \small{\insertframenumber / 15} \end{tabular}}
...
\title[Efficient and Effective Feedback Lesson Study]{Efficient and Effective Feedback: A Lesson Study Investigating Students' Responses to Feedback on Their Writing}
...
\frame
{
  ...
  \begin{block}{Four Goals}
      ...
      \item Improve the quality of feedback / make it useful.
...
{
  \ft{Feedback Content}
  Comments align to the learning goals for the assignment.
  ...
  \textcolor{blue}{\hyperlink{app}{Appendix: Comments for each learning outcome}}
}
...
\frame[label=app]
{
  \fta{Appendix: Comments for Feedback}
